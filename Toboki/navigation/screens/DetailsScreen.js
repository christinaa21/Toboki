      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ height: 211, marginTop: 20, alignItems: 'flex-start', position: 'absolute', top: 135, marginLeft: 15 }}>
          <ScrollView horizontal={true}>
            <Category imageUri={require('../../assets/klub-selera-1.png')} name="Pecinta Fiksi" subname="20 Member" />

            <Category imageUri={require('../../assets/klub-selera-2.png')} name="Bandung Book Lovers" subname="20 Member" />

            <Category imageUri={require('../../assets/klub-selera-3.png')} name="Good Reads Only" subname="20 Member" />
